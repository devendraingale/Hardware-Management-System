...
public class CreateNewAccountAdmin extends JFrame implements ActionListener,MouseMotionListener,MouseListener
{
	JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,limg,l11;
...
//***********************************************************************
		...
		t1.setBounds(620,150,200,30);  //name textBox
		t2.setBounds(620,200,200,30);    //Date TextBox
		t3.setBounds(620,250,200,30);    //contact  textBox
		t4.setBounds(620,300,200,30);     //e-mail textBox
		t5.setBounds(620,350,200,30);			//Password textBox
		t6.setBounds(620,400,200,30);
		l7.setBounds(830,200,150,30);
		l8.setBounds(650,300,100,30);
		l9.setBounds(680,400,100,30);
		l10.setBounds(510,20,300,30);
		b1.setBounds(520,480,100,30);
		b2.setBounds(670,480,100,30);
