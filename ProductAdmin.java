...
public class ProductAdmin extends JFrame implements ActionListener,ItemListener,MouseMotionListener,MouseListener
{
	JLabel l1,l2,l3,l4,l5,l6,l7,l8,l10,limg,l11;
...
//**********************************************Validation Code For product Name******************************************************************
									...
									int cnamel=cname.length();
									 for(int i=0;i<cnamel;i++)
								     {
											 ...
											 {
												JOptionPane.showMessageDialog(null,"Enter Correct Value in Name Box");
												c++;
												break;
											 }
...
//**********************************************Date Validation******************************************************************
									...
									for(int i=0;i<contactl;i++)
									{
											...
											{
													JOptionPane.showMessageDialog(null,"Enter Correct Value To Date");
													c++;
													break;
										    }
				...
				//***********************************************not null validation***************************************************************
					...
					String Gender;
								...
								int pid=Integer.parseInt(t1.getText());
			  					...
			  					{
									x=st.executeUpdate("update Product set Product_Name='"+t2.getText()+"',Product_Type='"+t3.getText()+"',Product_Date='"+t4.getText()+"',Product_Quantity='"+t5.getText()+"',Product_Amount='"+t6.getText()+"',Supplier_Name='"+n+"' where Product_ID="+pid);
									if(x>0)
									{
...
//*****************Delete Button Code******************************
	if(b==b5)
	{
			try
			{
						...
						if (selectedOption == JOptionPane.YES_OPTION)
			  			{
							 String str="Delete * from Product where Product_Id="+pid;
