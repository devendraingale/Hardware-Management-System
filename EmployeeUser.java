...
public class EmployeeUser extends JFrame implements ActionListener,MouseMotionListener,MouseListener
{
		...
		try
		{
				...
				if(temp==0)
				{
						...
						while (rs.next())
						{
							...
							JOptionPane.showMessageDialog(null,"Serach Sucessfully");
