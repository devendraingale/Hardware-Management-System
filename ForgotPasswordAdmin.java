...
public class ForgotPasswordAdmin extends JFrame implements ActionListener,MouseMotionListener,MouseListener
                            ...
                            try
                              {
								  ...
								  String h="Select * from CreatenewaccountAdmin where Email='"+email1+"'and Date='"+dob+"' and Name='"+name+"'";
		...
		if(b==b2)
		{
			try
			{
				...
				if(Pswd.equals(cPswd))
				{
						...
						cn=DriverManager.getConnection("jdbc:odbc:MDII");
				 		st=cn.createStatement();
				 		int x=st.executeUpdate("Update CreatenewaccountAdmin set Password='"+Pswd+"' where Email='"+t3.getText()+"'");
				 		if(x>0)
				 		{
